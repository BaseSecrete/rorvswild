...
RorVsWild.Local.prototype.toggleSection = function(event) {
  var id = parseInt(event.currentTarget.dataset.sectionId)
...
RorVsWild.Local.prototype.resetSectionFilters = function() {
  this.sectionKindFilter = null
  this.sectionQueryFilter = ""
  this.lowImpactExpanded = false
}

RorVsWild.Local.prototype.isFilteringSections = function() {
  return this.sectionKindFilter != null || this.sectionQueryFilter.length > 0
}

RorVsWild.Local.prototype.filterSections = function(sections) {
...
RorVsWild.Local.prototype.visibleSections = function() {
  var query = this.sectionQueryFilter
...
RorVsWild.Local.prototype.loadSections = function() {
  ...
  this.sections = execution.data.sections.map(function(section) {
    var runtime = (section.total_runtime - section.children_runtime)
    var impactValue = runtime * 100 / execution.data.runtime
    return {
      ...
      locationUrl: RorVsWild.Local.pathToUrl(execution.data.environment.cwd, section.file, section.line),
      isAsync: RorVsWild.Local.relevantRounding(section.async_runtime) > 0,
    }
  }).sort(function(a, b) { return b.selfRuntime - a.selfRuntime })
}

RorVsWild.Local.prototype.sectionsImpactPerKind = function() {
...
RorVsWild.Local.prototype.showLowImpactToggle = function() {
  return !this.isFilteringSections() && this.sections.some(function(section) { return section.isLowImpact })
}

RorVsWild.Local.prototype.lowImpactToggleLabel = function() {
...
RorVsWild.Local.prototype.renderSections = function() {
  ...
  var templates = Barber.partials()
  container.innerHTML = Mustache.render(templates["RorVsWild.Local.Sections"], this, templates)
