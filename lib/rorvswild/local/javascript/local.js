...
RorVsWild.Local.prototype.goToRequestDetail = function(event) {
  ...
  if (this.currentExecution) {
    ...
    this.currentExecution.renderSections()
  }
}
...
RorVsWild.Local.Request.prototype.renderSections = function() {
  var container = document.querySelector("[data-rorvswild-local-sections-container]")
  if (!container) return
  ...
  Barber.render("RorVsWild.Local.Sections", this, container)
