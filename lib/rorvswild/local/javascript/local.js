...
RorVsWild.Local.prototype.restoreOriginalContent = function(element) {
  if (element.dataset.rorvswildLocalSectionNameOriginal) {
...
RorVsWild.Local.prototype.filterSections = function() {
  ...
  if (hasNameFilter) {
    ...
    if (!kind) this.resetLowImpactSections()
  }

  if (toggleButton) toggleButton.style.display = hasNameFilter || kind ? "none" : ""
}
