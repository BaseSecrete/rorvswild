...
RorVsWild.Local.prototype.resetLowImpactSections = function() {
  var button = document.querySelector(".rorvswild-local-panel__toggle-low-impact__button")
  document.querySelectorAll(".rorvswild-local-panel__details__section[data-low-impact]").forEach(function(section) {
...
RorVsWild.Local.prototype.filterByKind = function(event) {
  ...
  var toggleButton = document.querySelector(".rorvswild-local-panel__toggle-low-impact")

  document.querySelectorAll(".rorvswild-local-panel__breakdown li").forEach(function(el) {
    el.classList.remove("is-active")
  })

  var sections = document.querySelectorAll(".rorvswild-local-panel__details__section")

  if (isActive) {
    this.resetLowImpactSections()
    sections.forEach(function(section) {
      if (!section.hasAttribute("data-low-impact")) section.classList.remove("is-hidden")
    })
